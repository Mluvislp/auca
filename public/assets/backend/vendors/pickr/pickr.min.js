...
!function(t, e) {
    ...
    return (()=>{
        ...
        function c(t) {
            return t instanceof Element ? t : "string" == typeof t ? t.split(/>>/g).reduce(((t,e,o,n)=>(t = t.querySelector(e),
            o < n.length - 1 ? t.shadowRoot : t)), document) : null
        }
        function p(t, e=(t=>t)) {
            function o(o) {
                ...
                let i = 0
                  , s = t.selectionStart;
                t.value = t.value.replace(/[\d.]+/g, ((t,o)=>o <= s && o + t.length >= s ? (s = o,
                e(Number(t), n, i)) : (i++,
                t))),
                t.focus(),
            ...
            const i = (t,e)=>(o=-1)=>e(~o ? t.map((t=>Number(t.toFixed(o)))) : t)
              , s = {
                ...
                toHSVA() {
                    ...
                    return t.toString = i(t, (t=>`hsva(${t[0]}, ${t[1]}%, ${t[2]}%, ${s.a})`)),
                    t
                },
                toHSLA() {
                    const t = [...v(s.h, s.s, s.v), s.a];
                    return t.toString = i(t, (t=>`hsla(${t[0]}, ${t[1]}%, ${t[2]}%, ${s.a})`)),
                    t
                },
                toRGBA() {
                    const t = [...f(s.h, s.s, s.v), s.a];
                    return t.toString = i(t, (t=>`rgba(${t[0]}, ${t[1]}, ${t[2]}, ${s.a})`)),
                    t
                },
                toCMYK() {
                    ...
                    return t.toString = i(t, (t=>`cmyk(${t[0]}%, ${t[1]}%, ${t[2]}%, ${t[3]}%)`)),
                    t
                },
                toHEXA() {
                    const t = function(t, e, o) {
        ...
        function $(t) {
                ...
                _keyboard(t) {
                    ...
                    if (document.activeElement === o.wrapper) {
                        ...
                        if ("keydown" === n && (s || r || a || l)) {
                            let n = 0
                              , i = 0;
                            "v" === o ? n = s || r ? 1 : -1 : "h" === o ? n = s || r ? -1 : 1 : (i = s ? -1 : a ? 1 : 0,
                            n = l ? -1 : r ? 1 : 0),
                            e.update(C(e.cache.x + .01 * n), C(e.cache.y + .01 * i)),
                            t.preventDefault()
                        } else
                            i.startsWith("Arrow") && (e.options.onstop(),
                            t.preventDefault())
                    }
                },
                _tapstart(t) {
            ...
            return i([o.wrapper, o.element], "mousedown", n),
        ...
        class L {
            constructor(t) {
                ...
                this._setupAnimationFrame = requestAnimationFrame((function e() {
                    ...
                    t.defaultRepresentation && (d._representation = t.defaultRepresentation,
            ...
            _preBuild() {
                ...
                this._root = (t=>{
                    const {components: e, useAsButton: o, inline: n, appClass: i, theme: s, lockOpacity: r} = t.options
                      ...
                      , u = p.interaction;
                    return u.options.find((t=>!t.hidden && !t.classList.add("active"))),
                  ...
                  , r = {
                    palette: $({
                        ...
                        onchange(o, n) {
                            ...
                            a.comparison ? a.useAsButton || t._lastColor || l.style.setProperty("--pcr-color", p) : (r.button.style.setProperty("--pcr-color", p),
            ...
            _bindEvents() {
                const {_root: t, options: e} = this
                  , o = [i(t.interaction.clear, "click", (()=>this._clearColor())), i([t.interaction.cancel, t.preview.lastColor], "click", (()=>{
                    ...
                    this.setColor(t.target.value, !0) && !this._initializingActive && (this._emit("change", this._color, "input", this),
                ...
                if (e.autoReposition && !e.inline) {
                    ...
                    o.push(i(window, ["scroll", "resize"], (()=>{
                        n.isOpen() && (e.closeOnScroll && n.hide(),
                        null === t ? (t = setTimeout((()=>t = null), 100),
            ...
            addSwatch(t) {
                ...
                if (e) {
                    ...
                    return o.swatches.appendChild(s),
                    t.push({
                        el: s,
                        color: n
                    }),
            ...
            removeSwatch(t) {
                ...
                if (e) {
                    const {el: o} = e;
                    return this._root.swatches.removeChild(o),
            ...
            applyColor(t=!1) {
                ...
                return e.lastColor.style.setProperty("--pcr-color", n),
