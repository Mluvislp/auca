...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Quản lý deal chớp nhoáng</li>
        </ol>
    </nav>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="card-title">Danh sách mã ưu đãi</h6>
                                        ...
                                        <td>
                                            <div class="btn-acction" style="display: flex;">
                                                ...
                                                <div class="btn-edit" style="margin-right: 10px;">
                                                    <a href="{{ route('edit_voucher') }}">Sửa</a>
                                                </div>
