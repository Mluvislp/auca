...
<div class="page-content">
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Đang chuyển đi</li>
    </ol>
  </nav>
  ...
  <div class="card">
    <div class="card-body">
      <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{{ route('transfer_move') }}">Đang chuyển đi</a>
        </li>
        <li class="nav-item">
      ...
      <div class="tab-content mt-3" id="lineTabContent">
        ...
        {{-- table 3 --}}
        <div class="tab-pane active" id="fixBuyPrice" role="tabpanel" aria-labelledby="buy-price-line-tab">
...
<script type="text/javascript">
  ...
  var dataTableConfig = {
      ...
      autoHeight: false,
      ajax: {
          url: '../../api/v1/transfer-ware/list/accept',
          type: 'GET',
