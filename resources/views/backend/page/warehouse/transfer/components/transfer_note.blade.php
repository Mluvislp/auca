        ...
        <div class="card">
            <div class="card-body">
                <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('transfer_note') }}">Phiếu nháp</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="filter">
                                        ...
                                        <div class="form-group input-group mb-0 pt-3">
                                            <div class="col p-0">
                                                <select class="form-select" aria-label="multiple select example"
                                                    name="filter_var_vg_id[]" id="filter_var_vg_id" custom-multiple
                                        ...
                                        <div class="form-group input-group mb-0 pt-3">
                                            <div class="col p-0">
                                                <input type="text" name="var_id" maxlength="255"
                                                    placeholder="ID Phiếu XNK" id="var_id" class="form-control"
                                                    value="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="collapse row m-0 col-12 pl-0 pr-0 mt-3 mb-3" id="filter-advanced-elements">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3 pr-0">
                                        ...
                                        <div class="row form-group input-group fInputHidden">
                                            <label class="col-form-label text-right col-12 pl-0 pr-0">Người xác
                                                nhận</label>
                                            <div class="col-12 pr-0">
                                                <input type="text" name="privateId" maxlength="30" id="privateId"
                                                    class="form-control" value="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group input-group fInputHidden">
                                            ...
                                            <div class="col-12 pr-0">
                                                <select class="form-select" aria-label="select example"
                                                    name="filter_var_cat_id[]" id="filter_var_cat_id">
                                            ...
                                            <div class="col-12 pr-0">
                                                <div class="row g-0 m-0 input-group">
                                                    ...
                                                    <div class="col">
                                                        <div class="input-group flatpickr" id="flatpickr-date">
                                                            <input type="text" class="form-control flatpickr-input"
                                                                placeholder="Đến ngày" data-input=""
                                                                readonly="readonly">
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row form-group input-group fInputHidden">
                                            ...
                                            <div class="col-12 pr-0">
                                                ...
                                                <div class="multiselect-dropdown" style="width: 0px;">
                                                    <div class="multiselect-dropdown-list-wrapper" style="display: none;">
                                                        <input class="multiselect-dropdown-search form-control"
                                                            placeholder="Tìm kiếm" style="width: 100%; display: block;">
                                            ...
                                            <table id="dataBatch12" class="table dataTable no-footer table-bordered"
                                                ...
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="sorting text-center text-black" tabindex="0"
                                                            aria-controls="dataBatch12" rowspan="1" colspan="1">
                                                            ID | Ngày
                                                        </th>
                                                        <th class="sorting text-center text-black" tabindex="0"
                                                            aria-controls="dataBatch12" rowspan="1" colspan="1">
                                                        ...
                                                        <th class="sorting text-center text-black sorting_asc"
                                                            tabindex="0" aria-controls="dataBatch12" rowspan="1"
                                                        ...
                                                        <th class="sorting text-center text-black" tabindex="0"
                                                            ...
                                                            <i class="icon-md text-black pb-3px"
                                                                data-feather="message-square" data-bs-toggle="tooltip"
                                                ...
                                                <tbody>
                                                    ...
                                                    {{-- <tr>
                                                        ...
                                                        <td class="text-start">
                                                            <p> <span>shangyang132</span> <i class="icon-lg pb-3px"
                                                                    data-feather="arrow-right"></i> <span>shangyang132
                                                                    1</span> </p>
                                                        ...
                                                        <td class="text-center">
                                                            <a class="text-success" href="#">123222222</a>
                                                            <p><span>2:03</span><span>19/07/2023</span></p>
                                                        </td>
                                                        <td class="text-start">
                                                            <p>
...
<script type="text/javascript">
  ...
  var dataTableConfig = {
      ...
      autoHeight: false,
      ajax: {
          url: '../../api/v1/transfer-ware/list/draft',
          type: 'GET',
