...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Thêm phiếu nháp chuyển kho</li>
        </ol>
    </nav>
    <form action="{{ route('suppliers.store') }}" method="post">
        ...
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Kho hàng</h6>
                        <form class="forms-sample">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-7 col-lg-9 d-flex align-items-center">
                                    <select class="form-select mb-3">
                                        <option selected="">- Từ kho -</option>
                                        <option value="">shangyang123</option>
                                    </select>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-2">
                                <div class="row">
                                  ...
                                  <div class="col-7 col-lg-9 d-flex align-items-center">
                                    <select class="form-select mb-3">
                                        <option selected="">- Đến kho -</option>
