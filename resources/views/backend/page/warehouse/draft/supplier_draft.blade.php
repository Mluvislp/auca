...
<div class="page-content">
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Thêm phiếu nháp nhà cung cấp</li>
        </ol>
    </nav>
                        ...
                        <table id="dataTableExampleHero" class="table dataTable no-footer table-bordered"
                          ...
                          <thead>
                            <tr>
                              ...
                              <th class="sorting text-center" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"
                                  aria-label="Position: activate to sort column ascending">Giá bán</th>
                              <th class="sorting text-center" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"
                                  aria-label="Position: activate to sort column ascending">Mô tả</th>
                              <th class="sorting text-center" tabindex="0" aria-controls="dataTableExample" rowspan="1" colspan="1"
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <textarea style="height: 50px;" class="form-control" name="sup_note" cols="30" rows="10" placeholder="Vui lòng nhập"></textarea>
                                </td>
                                <td class="text-center">
