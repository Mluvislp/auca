          ...
          <div class="col-12 col-lg-6">
            <div class="card-body">
              ...
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <select id="vv_parent_id" style="width: 100%" class="form-control" name="vv_parent_id">
                    ...
                    {{printVariantValue($variant_value)}}
                  </select>
                </div>
              </div>
              <div class="form-group mb-2 row">
              ...
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_value" id="vv_value" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_other_name" id="vv_other_name" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_code" id="vv_code" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_other_code" id="vv_other_code" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_unit" id="vv_unit" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
              <div class="form-group mb-2 row">
                ...
                <div class="col-lg-8">
                  <input type="text" name="vv_order" id="vv_order" autocomplete="off" class="form-control" value="">
                  <div class="error"></div>
                </div>
              </div>
            </div>
