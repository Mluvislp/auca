            ...
            <div class="filter">
              <div class="row mb-3">
                ...
                <div class="col-6 col-md-3 col-lg-1 pr-1">
                  <div class="form-group input-group mb-0 pt-3">
                    <div class="col p-0">
                      <input type="text" name="var_id" maxlength="255" placeholder="ID (TikTok)" id="var_id" class="form-control"
                        value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-6 col-md-3 col-lg-2 pr-1">
                  <div class="form-group input-group mb-0 pt-3">
                    <div class="col p-0">
                      <input type="text" name="var_id" maxlength="255" placeholder="Sản phẩm (TikTok)" id="var_id"
                    ...
                    <table id="dataTableExample" class="table dataTable no-footer table-bordered"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-start">
                            Kem đánh răng tinh dầu hương Cam ANRIEA KÈM QUÀ TẶNG - 2 KĐR TẶNG BÀN CHẢI PIN
                          </td>
                          ...
                          <td class="text-left">
                            ...
                            <span>
                              <a href="#">
                                Liệu trình miếng dán trắng răng Anriea 7days không hóa chất
                              </a>
                            </span>
                          </td>
                    ...
                    <table id="dataTableExampleV2" class="table dataTable no-footer table-bordered"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-start">
                            <p>A06.10A10</p>
                            <span class="text-primary">1729543003059423376</span><br>
                            <b>(Queen Box)</b>
                          </td>
                          <td class="text-start">Kem đánh răng tinh dầu hương Cam ANRIEA KÈM QUÀ TẶNG</td>
                          <td class="text-center">498.000</td>
                          <td class="text-center">
