                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <select class="form-select" multiple
                                                        aria-label="multiple select example" name="cat_tag[]"
                                                        id="cat_tag">
                                                    <option value="">Chọn</option>
                                                    @php
                                                        printCatTagMultipleChoise($cat_tag);
                                                    @endphp
                                                </select>
                                            </div>
                                            <div class="form-group mb-2">
                                            ...
                                            <div class="form-group mb-3" id="affter-save">
                                                ...
                                                <div
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="showList" type="radio" name="holdform"
                                                               value="N">
