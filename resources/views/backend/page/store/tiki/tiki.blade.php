...
<div class="page-content">
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Tiki</li>
    </ol>
  </nav>
      ...
      <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" id="history-line-tab" data-bs-toggle="tab" href="#history" role="tab"
            aria-controls="history" aria-selected="false">Sản phẩm chưa tạo sang Tiki</a>
        </li>
      </ul>
            ...
            <div class="filter">
              <div class="row mb-3">
                ...
                <div class="col-6 col-md-3 col-lg-1 pr-1">
                  <div class="form-group input-group mb-0 pt-3">
                    <div class="col p-0">
                      <input type="text" name="var_id" maxlength="255" placeholder="ID (TiKi)" id="var_id" class="form-control"
                        value="">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-6 col-md-3 col-lg-2 pr-1">
                  <div class="form-group input-group mb-0 pt-3">
                    <div class="col p-0">
                      <input type="text" name="var_id" maxlength="255" placeholder="Sản phẩm (TiKi)" id="var_id"
                ...
                <div class="row">
                  <div class="col-sm-12 table-responsive">
                    <table id="dataTableExample" class="table dataTable no-footer table-bordered"
                      ...
                      <tbody>
                        <tr>
                          <td class="text-center">62814642</td>
                          <td class="text-start">
                            <p>NRKCHONGNANGANTI</p>
                            <b>(tiki SY shop)</b>
                          </td>
                          <td class="text-start">
                            <a href="#">Máy Massage Mắt AINI Chống Lão Hóa Eye Beauty Fairy Stick (Màu ngẫu nhiên)</a>
                          </td>
                          <td class="text-center">216.000</td>
                          <td class="text-center">1</td>
                          <td class="text-start">
                            <p>(SXL017)</p>
                            <span>
                              <a href="#">
                                AINI - Máy massage mắt chống lão hoá Eye Beauty Fairy Stick
                              </a>
                            </span>
                          </td>
                    ...
                    <table id="dataTableExampleV2" class="table dataTable no-footer table-bordered"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-start">
                            <a href="#">
                              Kem Đánh Răng Muối Hồng Himalaya Bạc Hà (100ml) - Chính Hãng A20
                            </a>
                          </td>
          ...
          <div class="card-body p-0 pt-2">
            ...
            <div class="filter">
              ...
              <div class="collapse row m-0 col-12 pl-0 pr-0 mt-3 mb-3" id="filter-advanced-elements">
                ...
                <div class="col-12 col-md-4 col-lg-3 pr-0">
                  <div class="row form-group input-group fInputHidden">
                    <label class="col-form-label text-right col-4 pl-0 pr-0">Lọc sản phẩm</label>
                    <div class="col col-sm-8 pr-0">
                      <select name="inventory" id="inventory" class="form-control" aria-label="multiple select example"
                        name="filter_var_vg_id[]" id="filter_var_vg_id" multiple multiselect-search="true"
                        multiselect-select-all="true" multiselect-max-items="1">
                        <option value="otp1">Lọc sản phẩm</option>
                        <option value="otp2">Sản phẩm cha</option>
                        <option value="otp2">Sản phẩm độc lập</option>
                        <option value="otp2">Sản phẩm cha + độc lập</option>
                      </select>
                    </div>
                  </div>
                </div>
                    ...
                    <table id="dataTableExampleV3" class="table dataTable no-footer table-bordered"
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">Null</td>
                          <td class="text-start">A06.A20.A09.8A10.A13</td>
                          <td class="text-start">	Combo7days Miếng Dán Răng +1Kem Đánh Răng Muối Hồng+1hộp nước súc miệng- Tặng 8gói nước súc miệng+bàn chải A06A208A10A13</td>
