  ...
  <div class="card">
    <div class="card-body">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="">Có sửa giá nhập</a>
        </li>
        <li class="nav-item">
        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-line-tab">
          <div class="card-body p-0 pt-2">
            ...
            <div class="filter">
              <div class="row mb-3">
                ...
                <div class="col-6 col-md-3 col-lg-2 pr-1">
                  <div class="form-group input-group mb-0 pt-3">
                    <div class="col p-0">
                      <input type="text" name="log_prd_name" maxlength="100" placeholder="Sản phẩm" id="log_prd_name"
            ...
            <div class="table-responsive overflow-hidden">
              <div id="dataTableProduct3V2_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                <div class="row">
                  <div class="col-sm-12 table-responsive">
                    <table id="dataTableProduct3V2" class="table dataTable no-footer table-bordered"
                      aria-describedby="dataTableProduct3V2_info">
                      <thead class="table-light">
                        <tr>
                          <th class="sorting text-center text-black" tabindex="0" aria-controls="dataTableProduct3V2"
                            rowspan="1" colspan="1">
                            Mã sản phẩm
                          </th>
                          <th class="sorting text-center text-black sorting_asc" tabindex="0"
                            aria-controls="dataTableProduct3V2" rowspan="1" colspan="1" aria-sort="ascending">
                            Tên sản phẩm
                          </th>
                          <th class="sorting text-center text-black" tabindex="0" aria-controls="dataTableProduct3V2"
                            rowspan="1" colspan="1">
...
$(document).ready(function () {
  ...
  $('button[name=submit-filter]').click(function () {
    var dataTable = $('#dataTableProduct3V2').DataTable();
    dataTable.ajax.reload();
  });
  $('#dataTableProduct3V2').DataTable({
    serverSide: true,
    scrollX: true,
    scrollY: "600px",
    autoHeight: false,
