                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                            ...
                                            style="width: 306.925px;">TIÊU ĐỀ BÀI VIẾT</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 306.925px;">THUỘC DANH MỤC</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                            colspan="1" aria-label="Position: activate to sort column ascending"
                                            style="width: 306.925px;">CẤU HÌNH SLUG</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                            colspan="1" aria-label="Office: activate to sort column ascending"
                                            style="width: 146.275px;">NGÀY ĐĂNG TẢI</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                            colspan="1" aria-label="Age: activate to sort column ascending"
                                            style="width: 61.35px;">ĐƯỜNG DẪN BÀI VIẾT</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTableExample" rowspan="1"
                                        ...
                                        <td>
                                            <div class="btn-acction" style="display: flex;">
                                                                            ...
                                                                            <div class="card">
                                                                                <div class="card-body">
                                                                                    <ul class="nav nav-tabs nav-tabs-line" id="lineTab" role="tablist">
                                                                                        <li class="nav-item">
                                                                                          <a class="nav-link active" id="home-line-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Thông tin bài viết</a>
                                                                                        </li>
                                                                                        <li class="nav-item">
                                                                                          <a class="nav-link" id="profile-line-tab" data-bs-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Nội dung</a>
                                                                                        </li>
                                                                                      </ul>
                                                                                            ...
                                                                                            <form class="forms-sample">
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        ...
                                                                                                        class="form-label">Tiêu đề bài viết
                                                                                                    </label>
                                                                                                    <input type="text" class="form-control" id="exampleInputDisabled1" disabled="" value="Ăn gì để không mập">
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        for="exampleInputUsername1"
                                                                                                        class="form-label">Thuộc danh mục
                                                                                                    </label>
                                                                                                    <input type="text" class="form-control" id="exampleInputDisabled1" disabled="" value="Ăn uống">
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        for="exampleInputUsername1"
                                                                                                        class="form-label">Cấu hình slug
                                                                                                    </label>
                                                                                                    <input type="text" class="form-control" id="exampleInputDisabled1" disabled="" value="an-gi-de-khong-map">
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label
                                                                                                        for="exampleInputEmail1"
                                                                                                        class="form-label">Ngày đăng tải
                                                                                                    </label>
                                                                                                    <input type="text" class="form-control" id="exampleInputDisabled1" disabled="" value="15/03/2023">
                                                                                                </div>
                                                                                    ...
                                                                                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                                                                                        <div class="carousel-inner">
                                                                                            <div class="carousel-item active">
                                                                                                <img src="https://cdn-www.vinid.net/fe9611d1-top-cac-mon-an-khuya-khong-map.jpg" class="d-block w-100 h-100 rounded-0" alt="...">
                                                                                            </div>
                                                ...
                                                <div class="btn-edit" style="margin-right: 10px;">
                                                    <a href="{{ route('edit_blog') }}">Khôi phục</a>
                                                </div>
