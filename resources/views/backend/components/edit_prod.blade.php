...
<link rel="stylesheet" href="{{ asset('assets/backend/vendors/dropify/dropify.min.css') }}">
...
<div class="page-content">
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="{{ route('product') }}">Quản lý sản phẩm</a></li>
    ...
    <div class="row p-3">
      <div class="col-5 col-md-3 pe-0">
        <div class="nav nav-tabs nav-tabs-vertical" id="v-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link active" id="v-home-tab" data-bs-toggle="pill" href="#v-home" role="tab"
            aria-controls="v-home" aria-selected="true">Thông tin cơ bản</a>
          <a class="nav-link" id="v-info-tab" data-bs-toggle="pill" href="#v-info" role="tab" aria-controls="v-info"
            aria-selected="true">Thông tin bổ xung</a>
          <a class="nav-link" id="v-profile-tab" data-bs-toggle="pill" href="#v-profile" role="tab"
            aria-controls="v-profile" aria-selected="false">Thông tin khuyến mãi</a>
          <a class="nav-link" id="v-messages-tab" data-bs-toggle="pill" href="#v-messages" role="tab"
            aria-controls="v-messages" aria-selected="false">Tối ưu hóa seo</a>
        </div>
      </div>
      <div class="col-7 col-md-9 ps-0">
        <div class="tab-content tab-content-vertical border p-3" id="v-tabContent">
          <div class="tab-pane fade show active" id="v-home" role="tabpanel" aria-labelledby="v-home-tab">
            <div class="tab-body">
              <div class="row">
                  ...
                  <div class="card shadow-none">
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Mã sản phẩm</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                          ...
                          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                            <div class="col">
                              ...
                              <select class="form-select" name="age_select" id="ageSelect">
                                ...
                                <option>Nổi bật trong tuần</option>
                                <option>Quan tâm nhiều</option>
                              </select>
                            </div>
                            <div class="col">
                              <label for="exampleInputPassword1" class="form-label">Thuộc nhãn hàng</label>
                              <select class="form-select" name="age_select" id="ageSelect">
                ...
                <div class="col-md-6 grid-margin stretch-card mb-0">
                  <div class="card w-100 p-0 shadow-none">
                    <div class="card-body">
          ...
          <div class="tab-pane fade" id="v-info" role="tabpanel" aria-labelledby="v-info-tab">
            <div class="tab-body">
              <div class="row">
                <div class="col-md-6 grid-margin stretch-card mb-0">
                  <div class="card shadow-none">
                    <div class="card-body">
                      <h6 class="card-title">Thông số sản phẩm</h6>
                      <form class="forms-sample">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                            <div class="col">
                              <label for="exampleInputUsername1" class="form-label">Quy trình đóng gói</label>
                              <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                                placeholder="Nhập quy trình">
                            </div>
                            <div class="col">
                              <label for="exampleInputUsername1" class="form-label">Trọng lượng sản phẩm</label>
                              <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                        ...
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Hạn sử dụng</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                            placeholder="Nhập hạn sử dụng">
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Vệ sinh thực phẩm</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                            placeholder="Nhập giấy phép">
                        </div>
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Kho hàng</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                ...
                <div class="col-md-6 grid-margin stretch-card mb-0">
                  <div class="card shadow-none">
                    <div class="card-body">
                      <h6 class="card-title">Thành phần sản phẩm</h6>
                      <form class="forms-sample">
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Thành phần sản phẩm</label>
                          <textarea></textarea>
                        </div>
                      </form>
                    </div>
                ...
                <div class="col-md-6 grid-margin stretch-card mb-0">
                  <div class="card shadow-none">
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Tên quà tặng</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                        ...
                        <div class="mb-3">
                          <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2">
                            <div class="col">
                              ...
                              <div class="input-group flatpickr" id="flatpickr-date">
                                <input type="text" class="form-control flatpickr-input active"
                                  placeholder="Ngày phát hành" data-input="" readonly="readonly">
                            ...
                            <div class="col">
                              ...
                              <div class="input-group flatpickr" id="flatpickr-date">
                                <input type="text" class="form-control flatpickr-input active"
                                  placeholder="Ngày kết thúc" data-input="" readonly="readonly">
                                <span class="input-group-text input-group-addon" data-toggle=""><svg
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-calendar">
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="formFile">Hình đại diện | Yêu cầu: 40x40px</label>
                ...
                <div class="col-md-6 grid-margin stretch-card mb-0">
                  <div class="card shadow-none">
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        <div class="mb-3">
                          <label for="exampleInputUsername1" class="form-label">Tên combo</label>
                          <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
          ...
          <div class="tab-pane fade" id="v-messages" role="tabpanel" aria-labelledby="v-messages-tab">
            <div class="tab-body">
              <div class="card shadow-none">
                <div class="card-body">
                  <h6 class="card-title">Nội dung sản phẩm</h6>
                  <div class="mb-3">
                    <form class="forms-sample">
                      <label for="exampleInputUsername1" class="form-label">Cấu hình slug</label>
                      <input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"
                  ...
                  <div class="mb-3">
                    <form action="" class="test" method="post">
                      ...
                      <input type="text" id="exist-values" class="tagged form-control" data-removeBtn="true"
                        name="tag-2" placeholder="Nhập từ khóa tìm kiếm">
                    </form>
                  </div>
                  <div class="mb-3">
