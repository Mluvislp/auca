...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'prd_code'             => [
                'nullable' ,
                Rule::unique( 'product' , 'prd_code' )->ignore($this->prd_code, 'prd_code'),
            ] ,
            'prd_barcode'          => [
                'nullable' ,
                Rule::unique( 'product' , 'prd_barcode' )->ignore($this->prd_barcode, 'prd_barcode'),
            ] ,
            'pd_import_price'      => [
                'nullable' ,
                'numeric' ,
...
//                'mimetypes:image/jpeg,image/png,image/jpg,image/gif' ,
    ...
    public function messages(){
        return [
            'prd_id.required'            => 'Không lấy được sản phẩm.' ,
            'prd_id.integer'             => 'Không lấy được sản phẩm.' ,
...
//            'pd_image.mimetypes'         => 'Định dạng hình ảnh không được hỗ trợ. Vui lòng chọn định dạng hình ảnh JPG, JPEG, PNG hoặc GIF.' ,
            ...
            'country_id.integer'         => 'Quốc gia phải là một số nguyên.' ,
